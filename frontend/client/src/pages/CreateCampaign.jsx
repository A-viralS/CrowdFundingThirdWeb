...
const CreateCampaign = () => {
  ...
  return (
    <div className="bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4">
      {isLoading && <Loader />}
      <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] bg-blue-900 rounded-[10px]">
      ...
      <form onSubmit={handleSubmit} className="w-full mt-[65px] flex flex-col gap-[30px]">
        ...
        <div className="w-full flex justify-start items-center p-4 bg-blue-400 h-[120px] rounded-[10px]">
